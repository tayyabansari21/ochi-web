...
function navbar() {
    return (
        <div className="fixed z-[999] w-full py-[1.5rem] font-['Neue_Montreal'] bg-[#f1f1f100]/5 backdrop-blur-md" >
                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="nav-menu flex gap-8">
                        {["Services", "Our work", "About us", "Insights", "Contact Us"].map((item, index) => (
                            <a key={index} className={`text-lg capitalize font-normal ${index === 4 && 'ml-[17.5rem]'}`}>{item}</a>
                        ))}
                    </div>
                </div>
            </div>
